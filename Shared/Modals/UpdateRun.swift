                ...
                VStack {
                    ...
                    HStack {
                        ...
                        .alert(isPresented: $showingAlert, content: {
                            Alert(title: Text("Delete this Entry?"), message: Text("This cannot be undone"), primaryButton: .default(
                                ...
                                action: {
                                    ...
                                    firebaseRunsVM.deleteRun(docID: docIDInput)
                                    showSheet.toggle()
                                }
                            ))
                        })
                        ...
                        Button("Update", action: {
                            ...
                            firebaseRunsVM.updateRun(docID: docIDInput, sliderValueDoubleInput: u_sliderValue, totalMilesRanStringInput: u_totalMileString, totalTimeRanStringInput: u_totalTimeString, caloriesBurnedStringInput: u_caloriesBurnedString, quickCommentsStringInput: u_commentsString, runDateInput: u_runDate)
...
//        let objSpec = obj.listOfRuns[0]
        let fb = FirebaseRunsViewModel()
        let firstRun = fb.firebaseRuns[0]
        UpdateRun(firebaseRunsVM: FirebaseRunsViewModel(), docIDInput: firstRun.id ?? UUID().uuidString, u_sliderValue: firstRun.f_sliderVal, u_totalMileString: firstRun.f_totalMileStr, u_totalTimeString: firstRun.f_totalTimeStr, u_caloriesBurnedString: firstRun.f_caloriesBurnedStr, u_commentsString: firstRun.f_commentsStr, u_runDate: firstRun.f_runDate, showSheet: .constant(true))
